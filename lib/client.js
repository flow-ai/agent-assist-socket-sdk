...
var Client = /*#__PURE__*/function (_EventEmitter) {
  ...
  _createClass(Client, [{
    ...
    value: function start() {
      ...
      this._openConnection('start')["catch"](function (err) {
    ...
    **/
    ...
    key: "_openConnection",
    value: function () {
      var _openConnection2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(origin) {
        var resp;
    ...
    value: function _handleConnection(payload, counter) {
      var _this3 = this;
    ...
    value: function _reconnect() {
      ...
      this._reconnectTimeout = setTimeout(function () {
        ...
        _this5._openConnection('reconnect timeout');
      }, timeout);
    }
    /**
     * Disconnnect
