  ...
  _createClass(Client, [{
    ...
    value: function start() {
      ...
      this._openConnection()["catch"](function (err) {
        throw new _exception["default"]("Failed to start the client ".concat(err.message), 'connection', err);
      });
    }
    /**
    * Stop the client
    ...
    **/
    ...
    value: function _handleConnection(payload) {
      ...
      socket.onopen = function () {
        ...
        _this2.emit(Client.INIT, Client.GENERAL_NAMESPACE_META);

        clearInterval(_this2._keepAliveInterval);

        _this2._resetReconnectTimeout();

        _this2._keepAliveInterval = _this2._keepAlive();
      };
      ...
      socket.onerror = function (err) {
        ...
        switch (socket.readyState) {
          case 0:
            {
              _this2.emit(Client.ERROR, new _exception["default"]("".concat(msg, " Socket is busy connecting."), 'connection'));
          ...
          case 1:
            {
              _this2.emit(Client.ERROR, new _exception["default"]("".concat(msg, " Socket is connected."), 'connection'));
          ...
          case 2:
            {
              _this2.emit(Client.ERROR, new _exception["default"]("".concat(msg, " Connection is busy closing."), 'connection'));
          ...
          case 3:
            {
              _this2.emit(Client.ERROR, new _exception["default"]("".concat(msg, " Connection is closed."), 'connection'));
          ...
          default:
            {
              _this2.emit(Client.ERROR, new _exception["default"](msg, 'connection'));
      ...
      socket.onclose = function (evt) {
        ...
        if (evt.code === 1006) {
          _this2.emit(Client.ERROR, new _exception["default"]('The connection closed abnormally', 'connection', null, true));

          _this2.emit(Client.CLOSE, Client.GENERAL_NAMESPACE_META);
      ...
      socket.onmessage = function (evt) {
        if (typeof evt.data !== 'string' || evt.data.length === 0) {
          _this2.emit(Client.ERROR, new _exception["default"]('Failed processing websocket message', 'message'));
        ...
        switch (event) {
          ...
          case Client.BOT_REPLY:
            ...
            _this2.emit(Client.ASSIST_REPLY, {
              event: event,
              payload: payload,
              meta: meta,
              error: error
          ...
          case 'error':
            _this2.emit(Client.ERROR, new _exception["default"](payload, 'message', null, false, meta === null || meta === void 0 ? void 0 : meta.namespace));
    ...
    value: function _reconnect() {
      ...
      this._reconnectTimeout = setTimeout(function () {
        _this4.emit(Client.RECONNECT, Client.GENERAL_NAMESPACE_META);

        _this4._openConnection();
      }, timeout);
    }
    /**
     * Disconnnect
